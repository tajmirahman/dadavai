<section class="products-area pb-70">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            @forelse ($recentProduct as $product)
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-products-box">
                                ...
                                <ul>
                                    <li>
                                        <div class="wishlist-btn">
                                            <a type="submit" id="{{ $product->id }}" data-bs-toggle="modal"
                                                data-bs-target="#shoppingWishlistModal" onclick="addToWishList(this.id)">
                        ...
                        <div class="products-content">
                            <h3><a href="products-type-1.html">
