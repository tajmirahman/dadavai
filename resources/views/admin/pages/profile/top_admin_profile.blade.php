...
<div class="d-flex flex-wrap flex-sm-nowrap mb-3">
    ...
    <div class="flex-grow-1">
        ...
        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center mb-2">
                    <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{$profileData->name}}</a>
                    <a href="#">
                    ...
                    <a href="#"
                        ...
                        data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Supper Admin</a>
                </div>
                <!--end::Name-->
                <!--begin::Info-->
        ...
        <div class="d-flex my-4">
            <a href="" class="btn btn-sm btn-light-primary me-2">Employee
                Information</a>
        </div>
    </div>
    <!--end::Info-->
...
<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
    ...
    <li class="nav-item mt-2">
        <a class="nav-link text-active-primary ms-0 me-10 py-5 active {{ $routes == 'admin.profile' ? 'active' : '' }}"
    ...
    <li class="nav-item mt-2">
        <a class="nav-link text-active-primary ms-0 me-10 py-5"
            href="../../demo1/dist/account/billing.html">SMTP</a>
    </li>
    <!--end::Nav item-->
    <!--begin::Nav item-->
    <li class="nav-item mt-2">
        <a class="nav-link text-active-primary ms-0 me-10 py-5"
            href="../../demo1/dist/account/statements.html">SEO</a>
    </li>
    <!--end::Nav item-->
