            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">Total Offer Category <span
                            class="ms-2 badge bg-danger">{{ count($offerCategorys) }}</span></li>
                    <!--end::Item-->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="kt_datatable_example_5" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($offerCategorys as $key => $offerCat)
                                <tr>

                                    <td>{{ $key + 1 }}</td>
                                    <td>
                                        <img src="{{ asset('storage/offercategory/' . $offerCat->offer_category_image) }}"
                                    ...
                                    <td>
                                        ...
                                        @if ($offerCat->status == 1)
                                            <a href="{{ route('inactive.offer',$offerCat->id) }}" title="Inactive"><i
                                                    class="bi bi-hand-thumbs-down text-danger fs-3"></i></a>
                                        @else
                                            <a href="{{ route('active.offer',$offerCat->id) }}" title="Active"><i
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header" style="background: #6196A6;height: 50px;">
                                                        <h1 class="modal-title fs-5 text-white" id="exampleModalLabel">
                                                            Update Offer Category</h1>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>

            <form action="{{ route('update.offer.category') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <input type="file" autocomplete="off"
                                name="icon_image"
                                class="form-control form-control-sm imageIcon ">



                            <img src="{{ url('upload/no_image.jpg') }}"
                                class="showImageIcon mt-2" style="width:73px"
                                alt="" class="mt-3">
                        </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary btn-sm">Update
                                        ...
                                        <a href="{{ route('delete.offercategory', $offerCat->id) }}" class="ms-1" id="delete" title="Delete"><i
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header" style="background: #6196A6;height: 50px;">
                    <h1 class="modal-title fs-5 text-white" id="exampleModalLabel">Add Offer Category</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <form id="myForm" action="{{ route('store.offer.category') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="offer_category_name" class="form-control form-control-sm"
                                        placeholder="Offer Category Name" autocomplete="off">
                            ...
                            <div class="row  mt-3">
                                <div class="col-6">
                                    <label for="" class="mb-2">Icon Iamge</label>
                                    <input type="file" autocomplete="off" name="icon_image"
                                        class="form-control form-control-sm imageIcon ">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="file" autocomplete="off" name="offer_category_image"
                                        class="image form-control form-control-sm mb-2">
